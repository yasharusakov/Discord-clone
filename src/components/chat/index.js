        ...
        <div className="chat">
            <div className="chat__container">
                <header className="chat__header">
                    ...
                    <h3 className="chat__header-name">имя</h3>
                </header>
                <section className="channel__section">
                    <div>
                        <main>
                            <Message username={username} photoURL={photoURL} text={text} />
                        </main>
                        <form className="chat__form">
                            ...
                            <input onChange={(e) => setText(e.target.value)} autoComplete="off" placeholder="Написать #имя" type="text" />
                        </form>
                    </div>
                    <Members/>
                </section>
